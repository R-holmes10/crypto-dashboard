...
Open [http://localhost:3000](http://localhost:3000) to view it in your browser.
 ...
 <img src="https://github.com/devicons/devicon/blob/master/icons/heroku/heroku-original.svg" title="Heroku" alt="JavaScript" width="40" height="40"/>&nbsp;
  ...
  <b>➤ Chart Component :</b> This component enables users to select cryptocurrency and chart type( Bar and Line Chart ) from their respective dropdowns available. Also, there's an option to select the desired time interval to visualize the chart.
