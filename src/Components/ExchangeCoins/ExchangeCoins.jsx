...
function ExchangeCoins() {
  // state variables for getting input from the third party api's
  ...
  //below are the code to handle the input field validation
  ...
  //using useEffect (funtion)hooks for getting api data smoothly
  useEffect(() => {
    Axios.get(
  ...
  //function converting input data
  function convert() {
    var rate = info[to];
  ...
  return (
    <div className="w-full px-4 xl:px-3 dark:bg-gray-700 dark:text-white">
      ...
      {/* ---Div for: Exchange Coins Text below --- */}
