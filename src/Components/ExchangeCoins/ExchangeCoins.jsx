...
function ExchangeCoins() {
    ...
    return (
        <div className="w-full px-4 xl:px-6">
            ...
            <div className="font-bold font-mono pt-2 text-zinc-700 text-lg xl:text-2xl xl:pb-2 xl:pt-4">
            ...
            <div className="flex place-content-between xl:place-content-stretch">
                ...
                <input
                        type="text"
                        className={`border ${ errors.enterValue &&
                        "focus:border-red-500 focus:ring-red-500 border-red-500"} rounded-md h-10 text-slate-400 w-24 xl:w-36 focus:outline-none px-2 py-2`}
                        {...register("enterValue", { required: "Number is required",
                        pattern:{
                        ...
                        message: 'Error! please enter only integer'
                        },
                        })}
                        placeholder="Enter Value"
                        onChange={(e) => {
                ...
                {errors.enterValue && <span className="text-sm text-red-500">{errors.enterValue.message}</span>}
                    <p className="px-[10px] py-2 xl:pt-4 text-sm xl:w-36 text-teal-500 font-medium">
