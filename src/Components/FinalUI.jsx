...
import MarketCapEndPoint from './Coin/MARKETCAP_ENDPOINT';
        ...
        <div className="p-6 md:px-10 lg:flex dark:bg-slate-800 bg-slate-100 place-content-between">
            ...
            <div className="lg:w-screen">
                ...
                <div className="space-x-6 flex">
                    <div className="w-28 h-10 bg-white dark:bg-gray-700 flex justify-center drop-shadow rounded-md">
                        <FiatDropdown />
                    </div>
                ...
                <div className="dark:bg-gray-700 mt-6 bg-white drop-shadow rounded-md h-[30rem]">
                    <div><MainChart /></div>
                </div>
                {/* --- Chart --- */}
